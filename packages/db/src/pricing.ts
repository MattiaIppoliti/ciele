 ...
 * (apps/web/src/lib/runtime/catalog.ts) and the embedding models the retrieval
 * layer can resolve (apps/web/src/lib/runtime/embeddings.ts). Embedding models
 ...
 * apps/admin/CLAUDE.md) and prices through its own service-role reads.
 *
