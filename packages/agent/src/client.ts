...
// Reply Component names (generative UI): chat clients switch on this to pick
// which component a `component` part renders. Type-only; zod schemas and part
// builders stay server-side.
...
// deliberately not from `render-tools.ts`, which would pull the zod schema
// into the bundle.
