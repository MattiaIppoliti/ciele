...
il servizio in hosting, un self-host Docker e lo stack locale di Ciele Desktop.
...
- Utilizza Node.js 22.6 o una versione successiva.
...
| `manage_teammates` | Gestisci i colleghi IA e leggi le tue conversazioni con i colleghi. |
| `manage_channels` | Leggi e modella i canali dei colleghi di cui fai parte. |
...
Consulta [AI clients](/developers/ai-clients) per la configurazione di ciascun
client supportato.

## Controlla la connessione

Chiedi al cliente di chiamare `ciele_identity`. Conferma l'ID organizzazione, il
