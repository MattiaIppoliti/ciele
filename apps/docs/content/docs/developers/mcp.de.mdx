...
Operation nur einen Ausführungspfad hat, unabhängig davon, welcher Transport ihn
angefordert hat.
...
In der Revision `2026-07-28` wurden Protokollsitzungen entfernt. Jede Anfrage
...
| `manage_teammates` | Verwalten Sie KI-Teamkollegen und lesen Sie Ihre eigenen Teamkollegen-Gespräche. |
...
Bitten Sie den Kunden, `ciele_identity` anzurufen. Bestätigen Sie die erwartete
