...
description: Utilizza una sola API key con l'API di Ciele, la CLI o il server MCP.
---
...
Per trovare l'operazione corrispondente a un comando della console, apri il
[Pannello sviluppatore](/developers/developer-panel) in quella pagina.
...
predefinita. Un'installazione self-hosted utilizza il proprio public origin.
