...
Die API stellt nicht alle Konsolenfunktionen zur Verfügung. So bleiben
beispielsweise das Hochladen von Avataren und das Erstellen von Verbesserungen
der Konsole vorbehalten.
