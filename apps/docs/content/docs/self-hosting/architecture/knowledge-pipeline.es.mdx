...
El tiempo de ejecución puede recuperar Conceptos mediante búsqueda vectorial y
reserva léxica. El modo de grafo puede añadir navegación a través de las
relaciones indexadas de los Conceptos.
...
La búsqueda profunda aumenta la navegación por el conocimiento dentro de los
límites del entorno de ejecución. No realiza consultas en la web pública.
