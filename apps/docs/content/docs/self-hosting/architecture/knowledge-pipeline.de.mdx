...
Deep Search verbessert die Wissensnavigation innerhalb der Grenzen der Laufzeit.
Es werden keine Abfragen im öffentlichen Web durchgeführt.
...
Graphen und den Suchdaten entfernt. Ein erneutes Durchforsten der Website
startet die Extraktion und Indizierung für diese Quelle neu.
