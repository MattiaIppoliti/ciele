...
<Mermaid
  title="Die Beziehungen zwischen Hauptmandant und Laufzeit"
  chart={`
erDiagram
...
Gemeinsam genutzte Entitäten stellen allgemeine Organisationsdaten bereit.
Entitäten im Benutzerbereich benennen ein Identitätsattribut für die
...
auf. Eine Benachrichtigung erstellt keine Besuchernachricht.

Langzeit-Speicher gehören zu einer Organisation und zu einem verifizierten
SSO-Subjekt. Sie speichern eine dauerhafte Tatsache, eine Einbettung,
...
Fakt aus der zukünftigen Prompt-Einfügung und aus Speichersuchen entfernt.
