...
When the account is connected, the **Automatic** crawler uses Apify for all crawls. The crawl stops at the value of **Max pages to crawl**, which is 20 by default. Increase this value for a large website.
