 ...
 * request.
 *
 * Scheduled every five minutes by the self-hosted worker. Vercel Hobby only
 * accepts daily cron entries, so its hosted safety-net is daily while the
 * durable after-response accelerator handles ordinary traffic. Protected by
