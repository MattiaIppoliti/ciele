...
/**
 * Nightly graph-learning pass (ADR-0017 / #389). For one rotating bounded batch
 * of active graph datasets (cross-org, via the service role), it applies feedback weights, the zero-LLM
