  ...
  return (
    <ContextMenu>
      ...
      <ContextMenuContent ariaLabel={`Actions for ${key}`} className="w-60">
        ...
        >
          <AnimatedGlyph icon={Maximize2Icon} size={16} /> Open full screen
        </ContextMenuItem>
        {!canEdit ? null : (
          <>
            <ContextMenuSeparator />
            ...
            <div className="relative px-1 pb-1.5">
              ...
              <Input
                ...
                className={`h-8 pl-8 text-[0.8125rem] transition-shadow ${
            ...
            >
              ...
              {visibleMembers.map((m) => (
                ...
                >
                  <UserAvatar userId={m.userId} email={m.email} size="size-5" />
