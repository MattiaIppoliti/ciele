...
export function CitationList({
  ...
  if (collapsible) {
    return (
      <details className={`group ${className ?? ""}`}>
        <summary className="text-muted-foreground hover:text-foreground inline-flex w-fit cursor-pointer list-none items-center gap-1 rounded-full border px-2 py-0.5 text-2xs font-semibold transition-colors">
  ...
  return (
    <div className={className}>
      <p className="text-muted-foreground mb-1.5 text-2xs font-semibold">
