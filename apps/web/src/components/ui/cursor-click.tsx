...
/* Kept on the hand-written scaffold rather than `createAnimatedIcon`: this icon
   drives TWO animation controls (the pointer, then the click rays on a delay),
   and the factory hands the render function a single `controls`. */
