              ...
              {COLUMNS.map((column) => (
                <div key={column.title}>
                  ...
                  <ul className="mt-4 space-y-3 text-sm">
                    {column.links.map((link) => (
                      <li key={link.name}>
                        <Link
                          ...
                          className="press-text text-foreground/80 hover:text-foreground transition-colors"
                        >
                          {link.name}
                        </Link>
                      </li>
                    ...
                    {column.title === "Legal" ? (
                      <li>
                        <CookiePreferencesButton className="press-text text-foreground/80 hover:text-foreground cursor-pointer text-left transition-colors" />
                      </li>
                    ) : null}
                  </ul>
                </div>
