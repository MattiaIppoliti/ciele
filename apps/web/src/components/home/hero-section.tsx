        ...
        <div className="text-center">
          ...
          {installCommand && (
            ...
            >
              ...
              <p className="text-muted-foreground mt-4 text-balance text-[0.9375rem]">
                Downloads and runs the whole stack on your own machine:
                console, widget, database, background jobs.{" "}
                <Link
                  href="/download"
                  className="press-text text-foreground underline underline-offset-4 hover:no-underline"
                >
                  Run it yourself
                </Link>
              </p>
