      ...
      {hasWords ? (
        <span className="relative inline-grid">
          ...
          <motion.span
            ...
            aria-hidden
            // --chromatic-sweep is declared here as well as in `style`:
            // with it only in `style`, motion has no start value for the
            // custom property and writes `--chromatic-sweep: undefined` onto
            // the element, which breaks every calc() in the gradient.
            initial={
              reduceMotion
                ? false
                : {
