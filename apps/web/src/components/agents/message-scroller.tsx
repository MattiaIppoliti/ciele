...
export function MessageScroller({
  ...
  const setViewportRef = useCallback(
    // eslint-disable-next-line react-hooks/immutability -- standard forwarded-ref merge: the external ref object is *meant* to be written from this ref callback (commit time, never render).
  ...
  // Leaving rail mode clears the rail state during render (derived-state
  // adjustment) so the observer effect below never calls setState directly.
