  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <ChatMarkdown text={WELCOME} className="text-[0.9375rem]" />
          ...
          <div className="space-y-2 pt-1">
            <span className="border-primary text-primary flex w-full items-center justify-center gap-1.5 rounded-lg border px-4 py-2.5 text-center text-[0.9375rem] font-medium">
              Billing & invoices
            </span>
            <span className="border-primary text-primary flex w-full items-center justify-center gap-1.5 rounded-lg border px-4 py-2.5 text-center text-[0.9375rem] font-medium">
              Talk to a human
