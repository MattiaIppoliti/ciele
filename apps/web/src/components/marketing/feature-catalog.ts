...
export interface FeatureEntry {
  slug: string;
  /** Same icon the corresponding console navigation item uses. */
  icon: LucideIcon;
...
export const FEATURES: FeatureEntry[] = [
  ...
  },
  {
    ...
    label: "Teammates",
    eyebrow: "Inside the company",
    headline: "AI Teammates who read what you read",
    standfirst:
      "A Teammate is an AI colleague your people talk to in the console. It answers from the knowledge you give it, and it can do the work it has been granted.",
    shot: { kind: "teammates" },
    meta: "AI colleagues your team chats with in the console, scoped to the knowledge you choose and the actions you grant.",
    points: [
      {
        title: "Internal by construction",
        body: "A conversation belongs to an assistant or to a Teammate, never both. Your team's chat cannot land in the Inbox or count toward the Insights your visitors move, because the schema will not hold it there.",
      },
      {
        title: "Granted, not assumed",
        body: "A Teammate does nothing until you grant it a domain, and the absence of a grant is a refusal rather than a default. Each one sits under a ceiling you set, and that ceiling stops at publishing. Administering the organization is not a rung on the ladder.",
      },
      {
        title: "It remembers three things",
        body: "What you told it about how you work, what it has learned doing the job, and the project it is attached to. All three go into every turn whole, because the top few sentences of your own conventions is a worse input than none.",
      },
    ],
    coda: {
      eyebrow: "A room, not an inbox",
      headline: "Name two, and two answer",
      body: "A Teammate is not a private assistant each person keeps to themselves. Put several in a group, name the ones you want with @, and they each answer the one message from their own knowledge, on their own reply, under their own face. Nobody who was not named says anything, and a single message is capped at ten replies so a room cannot talk to itself.",
      mock: "group",
    },
  },
  {
    ...
    standfirst:
      "Point an assistant at your websites, the tools your team already works in, your files and your FAQs. It answers from those, and cites the source behind every claim.",
    shot: { kind: "mock", mock: "knowledge" },
    meta: "Crawl websites, connect Salesforce, ServiceNow, Slack, OneDrive and Google Drive, upload files and curate FAQs. Assistants answer from your organization's content and cite the source.",
    points: [
      {
      ...
      {
        title: "The tools you already work in",
        body: "Connect Salesforce, ServiceNow, Slack, OneDrive or Google Drive and import what you choose: published Knowledge articles, named channels, one folder. The connection runs on the account that authorised it, so an assistant never reaches further than the person who connected it could.",
      },
      {
