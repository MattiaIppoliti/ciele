    ...
    <main className="relative px-4 pb-8 pt-28 sm:px-8 sm:pt-36 lg:px-12">
      <div className="mx-auto w-full max-w-6xl">
        <SectionHeading
          ...
          description={feature.standfirst}
        />
        ...
        {feature.coda && (
          <section className="mt-24 overflow-hidden">
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between lg:gap-12">
              ...
              <p className="text-muted-foreground text-base leading-relaxed text-pretty lg:max-w-md">
                {feature.coda.body}
              </p>
            </div>
            <div className="mt-12">
              {feature.coda.mock === "preview" ? (
                <PreviewCoda />
              ) : feature.coda.mock === "group" ? (
                <GroupCoda />
              ) : (
                <KanbanMock />
              )}
              ...
              <li key={entry.slug}>
                ...
                <Magnetic range={44} intensity={0.12} maxOffset={6}>
                  <Link
                    ...
                    className="press-text group text-muted-foreground hover:text-foreground flex items-baseline gap-2 py-1 duration-150"
                  >
