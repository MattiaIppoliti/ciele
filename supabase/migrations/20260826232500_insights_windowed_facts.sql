-- Apply the windowed Insights fact scan to databases that already ran the
-- original overview migration. Role filter options remain Organization-wide,
-- while message, feedback and notification facts are computed only for the
