-- Backfill: a demo seed was applied to the live project on 2026-07-03 before
-- it was captured as a local migration file; added here so a fresh environment
...
-- Extra custom flows for the PROD assistant.
insert into public.flows (id, assistant_id, name, description, built_in, enabled, position, actions, custom_message, is_default)
values
