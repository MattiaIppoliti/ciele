...
- Every chat surface shares one pipeline and one registry; differing reach is
  entirely a function of the subject the route resolves. New surfaces pick a
  subject type, not a tool list.
